...
.container1 {
  ...
  <div class="container1">
   <center> 
   <h2 style="color:darkslategrey; margin-top:30px;">Forgot Password?</h2>
   <form action="forgot.php" style="margin-top:30px; padding:20px;" method="POST">
		<div class="form-group row">
            <div class="col-sm-10">
          <input type="number" class="form-control form-control-lg" id="colFormLabelLg" placeholder="Registered Id" name="name" required>
        </div>
		</div>
        <div class="form-group row">
            <div class="col-sm-10">
          <input class="form-control form-control-lg" id="colFormLabelLg" placeholder="Mobile Number" type="number" name="email" required>
        </div>
		</div>
