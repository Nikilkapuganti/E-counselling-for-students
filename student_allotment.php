...
.container1 {
											...
											while($res=mysqli_fetch_array($rss)){												  
												if(($result["userid"]) == ($res["faculty_id"])){
													echo '<tr class="table-info">
											              ...
											              <td><button class="button button2" data-toggle="modal" data-target="#exampleModal1" >Add Student</button></td></tr>';
  ...
  <div class="container1">
    <p> Enter faculty id here to view the students in his/her counselling</p>
			<center>
			<form name="myform" action="view_student_list.php" method = "POST">
			<div class="form-group row">
            <div class="col-sm-10">
              <input type="number" class="form-control" id="colFormLabelLg" placeholder="Enter Faculty Id" name="facultyid">
            </div>
