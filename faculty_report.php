										...
										while($result=mysqli_fetch_array($rs)){		
											...
											while($res=mysqli_fetch_array($rss)){												  
												if(($result["userid"]) == ($res["faculty_id"])){
												  ...
												  $variable1 = $result["username"]; ?>
											              <td><form method="post" action="student_list_report.php">
 <input type="hidden" name="text" value="<?php echo $variable; ?>">
  <input type="hidden" name="text1" value="<?php echo $variable1; ?>">
 <button type="submit" class="button button2">Student Reports</button>
</form></td>
														  <td><form method="post" action="view_overall_report.php">
 <input type="hidden" name="text" value="<?php echo $variable; ?>">
   <input type="hidden" name="text1" value="<?php echo $variable1; ?>">
 <button type="submit" class="button button2">Overall Report</button>
</form></td>
														  </tr>
														  <?php
