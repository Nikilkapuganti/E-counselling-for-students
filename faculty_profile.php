        ...
        <div class="row">
			<div class="col-4" >
				<div class="shadow-none p-3 mb-5 rounded" >
					...
					<div class="col-sm-6">';
					echo "<img src='$imgpath' height='250' width='250' style='margin-top:30px; margin-left:50px;'>
					";
								
		?>
<a data-toggle="modal" data-target="#exampleModal1"><button type="submit" style="margin-top: 10px; margin-left: 50px; width:150%;" class="button button2">Change Picture</button></a>
<a href="change_password_faculty.php"><button type="submit" style="margin-top: 10px; margin-left: 50px; width:150%;" class="button button2">Change Password</button></a>
<?php
  ...
  <div class="col-9">
  <textarea class="form-control" id="exampleInputEmail1" placeholder="<?php echo $address; ?>" disabled></textarea>
  </div>
  </div>
  <div class="row">
  <div class="col-3">
  ...
  <?php 
			...
			<a href="basicregistrationform.html"><button  class="btn btn-block">Fill Your Profile To Proceed</button></a></div>
			<?php
