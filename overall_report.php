...
.card:hover {
  ...
  <div class="container1">
   <center> 
   <h2 style="color:darkslategrey; margin-top:30px;">Overall Report</h2>
   <form action="overall_report_code.php" style="margin-top:30px; padding:20px;" method="POST">
		<div class="form-group row">
            <div class="col-sm-10">
          <textarea class="form-control form-control-lg" id="colFormLabelLg" placeholder="Major Problems Of Students" name="mps" required></textarea>
        </div>
		</div>
         <input type="hidden" name="text" value="<?php echo $session_id; ?>">
        <div class="form-group row">
            <div class="col-sm-10">
          <textarea class="form-control form-control-lg" id="colFormLabelLg" placeholder="Requests of Students" name="rs" required></textarea>
        </div>
		</div>
		<div class="form-group row">
            <div class="col-sm-10">
          <input class="form-control form-control-lg" id="colFormLabelLg" type="date" placeholder="Requests of Students" name="date1" required>
        </div>
		</div>
		<div class="form-group row">
            <div class="col-sm-10">
