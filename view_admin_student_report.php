...
.container1 {
  ...
  $sql="SELECT * from faculty_report where sid='$var'";
...
<div class="col-6">
  ...
  <div class="container1">
    <h4>View Report of <?php echo $var; ?></h4>
			<center>
			<form name="myform" action="view_admin_student_report1.php" method = "POST">
...
<div class="form-group row">
		  ...
		  <?php		 }else{
				echo '<p>Report of '.$var.' is Not generated</p>';
			} 
  ?>
          </form>
</div>
