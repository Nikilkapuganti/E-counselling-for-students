...
<?php
   ...
   $sql="SELECT * from student_assign where faculty_id = '$session_id'";
        ...
        <div class="row">
		<div class="col-8">
			<div class="col-md-8" style="margin-left:200px; margin-bottom:100px; margin-top:10px;">
...
<div class="col-4">
  ...
  <div class="container1">
    <p> Enter Student id here to view the students report</p>
			<center>
			<form name="myform" action="faculty_login1.php" method = "POST">
			<div class="form-group row">
            <div class="col-sm-10">
              <input type="number" class="form-control" id="colFormLabelLg" placeholder="Enter Student Id" name="studentid">
            </div>
...
<form name="myform" action="overall_report.php" method = "POST" style="margin-top:30px; margin-left:150px;">
						   
                    
          <div class="form-group row">
            <div class="col-sm-10">
               <input type="submit" name = "submit" class="btn btn-dark btn-s " value="Generate Overall Report" >    
