...
echo '<div class="container">
        <div class="row">
			<div class="col-md-8 offset-md-3">
				<center><span class="d-block p-2 bg-primary text-white " style="margin-top: 30px;"  >MY COUNSELLING STUDENTS </span></center>
			</div>
		</div>
      </div>                    
      <div class="container">
		<div class="row">
				...
				if (mysqli_num_rows($result) > 0) 
			{
				...
				echo '<button type="button" style="margin-top: 10px; margin-left: 350px;" class="btn btn-block"><a href="logintest.html">'.$res["student_id"].'</a></button>';  			
			}}
			else
			{
