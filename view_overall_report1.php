...
.container1 {
 ...
 $fid = $_POST['id'];
		$sdate = $_POST['date1'];
	$fname = $_POST['name'];
		$sql = "SELECT * from overall_report where faculty_id = '$fid' and date='$sdate'";
...
<div class="container">
		 ...
		 <center>  <h4 style="margin-bottom:50px;">View Overall Report of <?php echo $fname; ?></h4></center>
...
<div class="col-2">
			...
			<div class="col-2">
					<label>Majority Of Problems:</label>
				</div>  
			...
			<div class="col-2">
					<label>Majority of Requests:</label>
				</div>  
				<div class="col-4 p-1 mb-3 rounded" style="background-color:skyblue;">
					<?php echo $res['rs']; ?>
				</div>
